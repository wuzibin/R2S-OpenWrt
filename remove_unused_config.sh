...
[ -f configs/config_rk3328 ] && echo -e '\nCONFIG_KERNEL_BUILD_USER="Zibin Wu"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ZibinWu"' >> configs/config_rk3328
[ -f configs/config_h5 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Zibin Wu"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ZibinWu"' >> configs/config_h5
[ -f configs/config_h3 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Zibin Wu"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ZibinWu"' >> configs/config_h3
